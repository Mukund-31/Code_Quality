...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { error: signUpError } = await signUp(
      formData.email,
      formData.password,
      { name: formData.name, full_name: formData.name, username: formData.username, email: formData.email }
    );
        ...
        <Container>
          <div className="max-w-md mx-auto">
            <div className="bg-dark-900/50 backdrop-blur-sm border border-dark-800 rounded-2xl p-8 text-center">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Welcome to Code Quality!</h2>
